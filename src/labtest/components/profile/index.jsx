...
import { country, editProfilelab, updateProfilelab } from '../../../LabtestApi/labtest';
const Profile = () => {
  let history = useHistory();
  const [pro, setpro] = useState(false);
  const {  name, lname, email, about, address, address1, img, address2, certificate_img, city, clinic_img, company, deliver, dob, gender, mob, photo_id, pincode, state, time_sedule } = pro;
  console.log( name, lname, email, about, address, address1, img, address2, certificate_img, city, clinic_img, company, deliver, dob, gender, mob, photo_id, pincode, state, time_sedule,"All Data")
  ...
  const handleUpdate = (e) => {
    ...
    try {
      const result = updateProfilelab(name, lname, img, email, about, address, address1, address2, certificate_img, city, clinic_img, company, deliver, dob, gender, mob, photo_id, pincode, state, time_sedule
      );
