...
import { mediciene, pharmacyfilter } from '../../../../API/Filter/filterpharmacy';
...
const Producthealthcare = (props) => {
	...
	const[mediciencefilter,setmediciencefilter]=useState({
		product:'',
		categoryid:''
	})
	const getData = () => {
	...
	const{product}=pharmacyfilter
	console.log(mediciencefilter,"medicience");
	const checkboxselected=(e)=>{
          let id= e.target.name
		  setIsChecked(id)
		  alert(id)
	    setmediciencefilter({...mediciencefilter,categoryid:id})
		
	}
	const medicinesubmit=()=>{
		  mediciene(mediciencefilter).then((res)=>{
			if(res  && res.results){
				console.log(res.results,"fjfjfjjfj");
				setPost(res.results)
				...
				<div className="container-fluid">
					<div className="row">
						<div class="search-box">
							<input type="search" class="form-control"  value={product}
							...
							<StickyBox offsetTop={20} offsetBottom={20}>
								<div className="card search-filter">
									<div className="card-header">
                                        ...
                                        setmediciencefilter({...mediciencefilter,product:e.target.value})
							}} />
									</div>
...
<button onClick={medicinesubmit}>handlesubmit</button>
														...
														<div className="row align-items-center">
															...
															<div className="col-lg-6 text-end">
																<Link to="/Pharmacy/cart" className="cart-icon">
																	<i className="fas fa-shopping-cart" onClick={() => AddToCart(items)} />
																</Link>
															</div>
														</div>
													</div>
