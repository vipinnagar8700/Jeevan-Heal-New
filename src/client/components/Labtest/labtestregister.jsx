...
import { labRegister } from "../../../LabtestApi/labtest";

const labtestregister = (props) => {
  ...
  const HandleClick = (values) => {
    ...
    console.log("Vipin Register Labtest", values.phone, values.password, values.name, values.email,values.role)

    // let role = "pharmacy";
    let labData = labRegister(values);
    if (labData) {
      labData.then((data) => {
        console.log(data)
