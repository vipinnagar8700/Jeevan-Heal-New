...
import CountryState from './components/countryState.js';

import SearchDoctorfilter from './components/pages/searchdoctorfilter';
    ...
    return (
			<Router>
				...
				<Switch>
					...
					<Route path="/patient/search-doctor-filter" exact component={SearchDoctorfilter} />
					...
					<Route path="/Country" exact component={CountryState }  />
				</Switch>
